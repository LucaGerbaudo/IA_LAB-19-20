...
%*v7 :- 
    ...
    N_LCS > N_ICT.          % prima ora di lcs dopo ultima ora di ict
    N_PSAWDMI > N_LCS.      % prima ora di psawdmI dopo ultima ora di lcs
    N_PSAWMII > N_PSAWDMI,  % prima ora di psawmII dopo ultima ora di psawdmI
    N_TSS > N_PBD,          % prima ora di tss dopo ultima ora di pBD
    N_LCS > N_LM,           % prima ora di lcs dopo ultima ora di lm
