...
public class NodiIrrilevanti {
    ...
    public static void main(String[] args) {
        ...
        BayesianNetwork bn = BifReader.readBIF("asia.xml");
        ...
        qrv[0] = rvsmap.get("Lung");

        System.out.println("VAL RVSMAP: " + rvsmap.toString());

        AssignmentProposition[] ap = new AssignmentProposition[1];
        ap[0] = new AssignmentProposition(rvsmap.get("Tub"), "Yes");
        ...
        for (RandomVariable v : bn.getVariablesInTopologicalOrder()) {
            if (isIrrelevant(bn, v, qrv, ap)) {
                irrelevants.add(v);
                System.out.println("IRRELEVANT_1 : " + v.getName() + " ****** " + aus);
                aus++;
        ...
        System.out.println("NIRR 2: " + nodiIrrilevanti2.toString() + " - LEN: " + nodiIrrilevanti2.size());
        for (RandomVariable v : nodiIrrilevanti2) {
            System.out.println("IRRELEVANT_2 : " + v.getName() + " ****** " + aus);
            aus++;
            if (k < nodiIrrilevanti2.size() - 2) {
                ap2[k++] = new AssignmentProposition(v, "Yes");
                ap2[k++] = new AssignmentProposition(v, "No");
            }

            System.out.println("VAL INSERITI: " + ap2[k - 1]);
            System.out.println("VAL INSERITI: " + ap2[k - 2]);
        ...
        try {
            ...
            System.out.println("RICALCOLO CPT ERROR: " + e.getMessage());
        }
...
//**********************************************************************************************************
    ...
    private static Factor makeFactor(RandomVariable var, AssignmentProposition[] e,
        ...
        try {
            ...
            System.out.println("MAKE FACTOR ERROR: " + e1.getMessage());
        }
        return null;
    }
