...
public class ExampleRV {
	...
	public static final RandVar STIFF_NECK_RV = new RandVar("StiffNeck",
			new BooleanDomain());
	//
	public static final RandVar BURGLARY_RV1 = new RandVar("Burglary_t-1",
			new BooleanDomain());
	public static final RandVar EARTHQUAKE_RV1 = new RandVar("Earthquake_t-1",
			new BooleanDomain());
	...
	public static final RandVar ALARM_RV = new RandVar("Alarm",
			new BooleanDomain());
	public static final RandVar ALARM_RV1 = new RandVar("Alarm-1",
			new BooleanDomain());
