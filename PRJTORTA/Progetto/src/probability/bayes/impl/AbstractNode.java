...
public abstract class AbstractNode implements Node {
    ...
    @Override
    public void removeParent(Node rnv) {
        Set<Node> newParents = new LinkedHashSet<>();
        for(Node n : this.parents) {
            if(!n.getRandomVariable().getName().equals(rnv.getRandomVariable().getName()))
                newParents.add(n);
        }
    ...
    @Override
    public void removeChildren(Node rnv) {
        Set<Node> newChildren = new LinkedHashSet<>();
