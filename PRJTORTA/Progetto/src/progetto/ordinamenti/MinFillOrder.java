...
public class MinFillOrder {
    ...
    public static List<RandomVariable> minFillOrder(BayesianNetwork bn) {
        ...
        for (int i = 0; i < len; i++) {
            RandomVariable rvSmallestNeighbour = rvWithSmallestNumEdges(interactionGraph);
    ...
    /**
     * Restituisce la variabile che aggiunge meno archi in G
     * @param graph
     * @return
     */
    private static RandomVariable rvWithSmallestNumEdges(Graph<RandomVariable, DefaultEdge> graph) {
    ...
    /**
     * Restituisce il numero di archi che eliminando la variabile bisogna aggiungere
     * @param graph
     * @param var
     * @return
     */
