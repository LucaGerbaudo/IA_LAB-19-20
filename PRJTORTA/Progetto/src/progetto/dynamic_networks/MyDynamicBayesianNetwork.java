...
public interface MyDynamicBayesianNetwork extends BayesianNetwork {
     ...
     *         X<sub>1</sub>.
     */
    Map<RandomVariable, List<RandomVariable>> getX_0_to_X_1();
     ...
     *         X<sub>0</sub>.
     */
    Map<List<RandomVariable>, RandomVariable> getX_1_to_X_0();
